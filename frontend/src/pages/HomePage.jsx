...
const HomePage = () => {
  ...
  const getStatusBadge = (status, hasSummary) => {
    const map = {
      completed: { cls: hasSummary ? 'mm-badge--success' : 'mm-badge--info', text: hasSummary ? 'Đã lưu tóm tắt' : 'Đã lưu bóc băng', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="20 6 9 17 4 12"></polyline></svg> },
